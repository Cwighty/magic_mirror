...
public class OVRLipSyncContextMorphTargetEditor : Editor
{
  ...
  SerializedProperty movementMultiplier;
  ...
  void OnEnable()
  {
    ...
    movementMultiplier = serializedObject.FindProperty("movementMultiplier");
  ...
  public override void OnInspectorGUI()
  {
    ...
    EditorGUILayout.PropertyField(movementMultiplier);
